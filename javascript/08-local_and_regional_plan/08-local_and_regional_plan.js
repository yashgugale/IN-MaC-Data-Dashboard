...
// B. Global variables:
var localAndRegionalPlanData = [];	// Store the principal data
...
var countyBarGraphProperties = {
	...
	chartPadding : 20,
	xLabel : "County Name",
	yLabel : "Local and Regional Plan Organization count",
...
var countyPieChartProperties = {
	...
	updatable : false,
	heightPadding : 5,
	tooltipData : "Total Local and Regional Plan Organizations in the region",
	tooltipHeight : "60px",
};
...
function init()
{
	...
	///////
	d3.csv("../data/08-local_and_regional_plan_data.csv").then(function(data)
	{
		var i = 0;
		data.forEach(function(d){
			// trim() function is used to remove trailing and leading whitespaces from the data:
			localAndRegionalPlanData.push([d.County.trim()]);								// Extract the County name
			localAndRegionalPlanData[i].push(d.Organization.trim());						// Extract the Organization name
			localAndRegionalPlanData[i].push(d["Contact Person"].trim());					// Extract the Contact name
			localAndRegionalPlanData[i].push(d.Email.trim());								// Extract the Email ID
			var url = d.Website;
			...
			localAndRegionalPlanData[i].push(url);										// Extract the webpage
			localAndRegionalPlanData[i].push(d.Region.trim());							// Append the region ID as the last element
			i++;
		...
		showDropDownData("Lake", "1", "localAndRegionalPlan", localAndRegionalPlanData);			// Show the school data
...
d3.json("../data/indiana_counties.json").then(function(indianaData) {
	...
	mapGroup.append("g")
			...
			.on("click", function(d){
				...
				showDropDownData(d.properties.NAME, d.properties.REGION_ID, "localAndRegionalPlan", localAndRegionalPlanData);
...
function generatePDF()
{
	...
	// Change this as well if the value is changed in the ecosystem generation js file:
	var ecosystemWidth = 1500;
	var ecosystemHeight = 1500;
	...
	doc.setFontSize(8);
	var mapText = "The following dataset provides information on all the Local and Regional Workforce Development Organizations located in the " + 
	...
	var mapTitleText = "Local and Regional Workforce Development Organizations in each county based on the 12 Indiana Economic Growth regions";
	doc.text(10, 35, mapTitleText, {'maxWidth' : maxWidth_1});
	doc.addImage(all_imgs[0], 'JPEG', 1, 40, 120 * mapWidth / mapHeight, 120 );
	

	// F. County bar graph:
	var countyBarGraphTitleText = "Distribution of the Local and Regional Workforce Development Organizations in a specific Economic Growth Region";
	...
	// G. Pie Chart:
	var pieChartTitleText = "Percent distribution of total Local and Regional Workforce Development Organizations across Indiana's 12 EGR";
	...
	// H: Stats field:
	var statsTitleText = "Statistics for the number of Local and Regional Workforce Development Organizations present in each Economic Growth Region";
	...
	doc.setFontSize(8);
	var all92CountyBarGraphTitleText = "Comparison of the total Local and Regional Workforce Development Organizations in various counties spread in different regions over the entire state of Indiana.";
	...
	// K. Add a new page for the Ecosystem visualization:
	doc.addPage();	

	// Add the In-MaC logo for the new page:
	var inMacLogo = "data:image/png;base64,";
	doc.addImage(inMacLogo, 'png', 160, 3, 40, 15);

	// Ecosystem title:
	var ecosystemText = "Ecosystem of Local and Regional Workforce Development Organizations in the state of Indiana";
	doc.text(10, 15, ecosystemText, {'maxWidth' : maxWidth_2});
	doc.addImage(all_imgs[4], 'JPEG', 5, 20, 200 * ecosystemWidth / ecosystemHeight, 200 );
	
	// Save the report:
	doc.save("Local and Regional Workforce Development Organizations Report.pdf")
